...
public struct ValueTuple<T1, T2, T3, T4, T5, T6> : IEquatable<ValueTuple<T1, T2, T3, T4, T5, T6>>, IComparable, IComparable<ValueTuple<T1, T2, T3, T4, T5, T6>> {
    public T1 Item1;
    public T2 Item2;
    public T3 Item3;
    public T4 Item4;
    ...
    public override int GetHashCode() {
        ...
        return CombineHashCodes(CombineHashCodes(h12, h34), h56);
    }
    ...
    int IComparable.CompareTo(object obj) {
        ...
        return obj is not ValueTuple<T1, T2, T3, T4, T5, T6> ? throw new ArgumentException("Object must be ValueTuple<T1,T2,T3,T4,T5,T6>.") : CompareTo((ValueTuple<T1, T2, T3, T4, T5, T6>)obj);
    }
}