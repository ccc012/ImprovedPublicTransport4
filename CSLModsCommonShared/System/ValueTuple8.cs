...
public struct ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest> :
    ...
    public override bool Equals(object obj) => obj is ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest> other && Equals(other);
    ...
    public override int GetHashCode() {
        ...
        var h8 = Rest == null ? 0 : Rest.GetHashCode();

        var h12 = CombineHashCodes(h1, h2);
        var h34 = CombineHashCodes(h3, h4);
        var h56 = CombineHashCodes(h5, h6);
        var h78 = CombineHashCodes(h7, h8);

        return CombineHashCodes(CombineHashCodes(h12, h34), CombineHashCodes(h56, h78));
    }
    ...
    int IComparable.CompareTo(object obj) {
        ...
        return obj is not ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest> tuple ? throw new ArgumentException("Object must be ValueTuple<T1,T2,T3,T4,T5,T6,T7,TRest>.") : CompareTo(tuple);
    }
}