...
CHANGENOTE = [
 u"Version 4.8.6 - Commuter Destination back, real disable-on-toggle audit",
 u"",
 u"COMMUTER DESTINATION",
 u"- Re-enabled: the Options toggle is back and works live, no reload needed.",
 u"",
 u"DISABLE-ON-TOGGLE AUDIT",
 u"- Elevated Stops Enabler was permanently rewriting road prefab data with no way to undo it once turned off. Fixed - it now fully reverts to vanilla when disabled.",
 u"- Auto Line Budget kept managing lines in the background after being disabled mid-session. Fixed - it now stops immediately and hands lines back to normal budget control.",
 u"- Every other optional integration was checked and already reverted correctly.",
 u"",
 u"NEW OPTIONS (Advanced tab)",
 u"- Two behaviours that always ran with no way to turn them off - auto-naming unnamed stops, and Rescue Fullwidth Digits (Gansaku) - now have their own toggle. On by default, so nothing changes unless you turn them off.",
 u"",
